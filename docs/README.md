...
| @Size | field, parameter-less method, method parameter | provide size or length validation rule for String, array, Collection and Map. |
...
* Base on [JSR380](https://jcp.org/en/jsr/detail?id=380)
